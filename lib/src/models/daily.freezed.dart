...
class _$DailyImpl implements _Daily {
  const _$DailyImpl({required this.id, required this.day});
...
abstract class _Daily implements Daily {
  const factory _Daily({required final int id, required final String day}) =
      _$DailyImpl;
